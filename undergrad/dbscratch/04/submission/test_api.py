...
data = get1(
    "http://localhost:12138/api/v1/get-issue-detail?issue_id=adcc6ae9-a1db-456a-aa49-427a7111c93e", {})
...
data = get1(
    "http://localhost:12138/api/v1/create-issue?title=Title&body=Issue%20Body", {})
print("create-issue: {}".format(json.dumps(data)))

if data['id'] != '':
    inserted_uuid = data['id']
    print('Inserted data at id: {}'.format(inserted_uuid))
else:
    n_err += 1
    print('FAIL')
...
data = get1(
    "http://localhost:12138/api/v1/update-issue?issue_id={}&title=Updated%20Title".format(inserted_uuid), {})
print("update-issue: {}".format(json.dumps(data)))

if data['n_rows'] == 1:
    print("Successfully updated a row")
else:
    n_err = n_err + 1
    print("FAIL")
...
data = get1("http://localhost:12138/api/v1/add-note-to-issue?issue_id={}&title=Added%20Note%20title&body=sometextforthebody".format(inserted_uuid), {})
print("add-note-to-issue: {}".format(json.dumps(data)))

if data["id"] != '':
    print('Create note on issue with uuid: {}'.format(data['id']))
else:
    n_err += 1
    print('FAIL')
...
data = get1("http://localhost:12138/api/v1/delete-note?note_id={}&issue_id={}".format(
    '727c7d7a-9548-4b3b-988f-1fe91e262b0e', '2de76413-d746-4941-886a-a8ef99255956'), {})
print("delete-note: {}".format(json.dumps(data)))

if data['n_rows'] == 1:
    print('Successfully deleted a note from issue')
else:
    n_err += 1
    print("FAIL")
...
data = get1(
    "http://localhost:12138/api/v1/delete-issue?issue_id=2de76413-d746-4941-886a-a8ef99255956", {})
print("delete-issue: {}".format(json.dumps(data)))
...
data = get1(
    "http://localhost:12138/api/v1/update-severity?issue_id={}&severity_id=3".format(inserted_uuid), {})
print("update-severity: {}".format(json.dumps(data)))
